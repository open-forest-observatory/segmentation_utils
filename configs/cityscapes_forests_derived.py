data_preprocessor = dict(
    ...
    mean=[111.13859077733052, 117.59985508060974, 102.2959851538855],
    std=[73.30937007947439, 72.43582125151995, 65.35098998632455],
    bgr_to_rgb=True,
    pad_val=0,
    seg_pad_val=255,
    size=(1024, 1024),
...
data_root = "/ofo-share/repos-david/semantic-mesh-pytorch3d/data/species-class-seed-kernel/training_data/chips/"
classes = ("ABCO", "CADE", "PILA", "PIPO", "PSME", "QUEV", "SNAG", "GROUND")
crop_size = (1024, 1024)
train_pipeline = [
